...
public class PacientesController : ControllerBase
{
    ...
    public async Task<IActionResult> Get() => 
        Ok(await _db.Pacientes.Select(p => new PacienteDto { 
            Codigo = p.Codigo, Nombre = p.Nombre, FechaNacimiento = p.FechaNacimiento 
        }).ToListAsync());
    ...
    public async Task<IActionResult> GetByCode(string codigo)
    {
        ...
        return p == null ? NotFound() : Ok(new PacienteDto { Codigo = p.Codigo, Nombre = p.Nombre, FechaNacimiento = p.FechaNacimiento });
    }
    ...
    public async Task<IActionResult> Post([FromBody] PacienteDto dto)
    {
        ...
        _db.Pacientes.Add(new Paciente { 
            ...
            FechaNacimiento = dto.FechaNacimiento, Estado = "Activo" 
        });

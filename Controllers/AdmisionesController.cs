...
public class AdmisionesController : ControllerBase
{
    ...
    public async Task<IActionResult> Crear([FromBody] AdmisionDto dto)
    {
        ...
        var cama = await _db.Camas.FirstOrDefaultAsync(c => c.Codigo == dto.CamaCodigo && c.EstadoOperativo == "Disponible");
        ...
        cama.EstadoOperativo = "Ocupada";  // Actualizar estado de la cama
